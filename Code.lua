...
--// Scroll frame replacing eee — zero scrollbar thickness
...
--// Extra bar — exact original positions
...
--// Card button — exact original visual
...
--// Server card — exact original layout
...
local function makeServerCard(data)
    ...
    --// Hover surface — ZIndex 2, sits behind the ZIndex 6 buttons
